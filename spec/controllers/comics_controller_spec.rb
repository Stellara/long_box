...
RSpec.describe ComicsController, type: :controller do
  ...
  let(:valid_attributes) {
    {
      ...
      year: 1939,
      printing: 1,
      publisher: 'Detective Comics',
      author: 'Bill Finger',
      artist: 'Bob Kane',
      cover_price: 0.10,
      cover_variant: nil,
      description: 'The first appearance of THE BATMAN.'
    }
  }

  let(:invalid_attributes) {
    {
      title: "Some Bad Comic",
      issue_number: "72",
      printing: 0,
      cover_price: -0.10
    }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        valid_attributes.merge(title: 'BATMAN')
      }
      ...
      it "updates the requested comic" do
        ...
        comic.reload
        expect(comic.title).to eq('BATMAN')
      end
